...
namespace TvsDumbPanel.Mods
{
    ...
    {
        public static void bluebaboonOn()
        {
            GameObject.Find("Global/CapuchinPhysRig/XR Origin/CapuchinPlayer/Main Camera/CameraChild/PlayerModel/BABNST").SetActive(true);
        }
        public static void bluebaboonOff()
        {
            GameObject.Find("Global/CapuchinPhysRig/XR Origin/CapuchinPlayer/Main Camera/CameraChild/PlayerModel/BABNST").SetActive(false);
        }
    }
}